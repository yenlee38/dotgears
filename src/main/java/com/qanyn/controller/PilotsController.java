...
public class PilotsController {
    ...
    public String editPilots(@PathVariable("post_id") String post_id,@PathVariable("pilots_id") int pilots_id, @Valid String pilots_content, @Valid String pilots_title,
    ...
    public String uploadThumnail(@PathVariable("post_id") String post_id, @PathVariable("pilots_id") int pilots_id, @RequestParam("image") MultipartFile inputFile) {
    ...
    public String createPilot(@PathVariable("id") String post_id, @Valid String pilots_content, @Valid String pilots_title,
                              @Valid String pilots_boodtype, @Valid String education, @Valid String pilots_hobbies,
                              @Valid String pilots_zodiac_sign,
                              @Valid String full_name,
    ...
    public String deleteOne(@PathVariable("post_id") String post_id, @PathVariable("pilots_id") int pilots_id) throws IOException {
